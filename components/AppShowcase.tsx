                ...
                <div className="mt-auto space-y-3">
                  {!app.webUrl && app.apkUrl && (
                    <div className="flex items-center justify-center rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 text-sm font-medium text-gray-600">
                      {app.apkUrl.includes('play.google.com') ? 'Disponível na Play Store' : 'Disponível para Android'}
                    </div>
                  )}
                  {app.webUrl && (
                    <a
                  ...
                  {app.apkUrl && (
                    ...
                    >
                      ...
                      {app.apkUrl.includes('play.google.com') ? 'Baixar na Play Store' : 'Baixar APK'}
                    </a>
                  )}
                </div>
              </div>
